...
public class comunDropdown {
    ...
    public static void  main(String [] args){
        ...
        // Seleccion por index tomando como referencia un array
        //oldStyleMenu.selectByIndex(10);

        // Seleccion por un value
        //oldStyleMenu.selectByValue("5");

        // Seleccion por un Text
